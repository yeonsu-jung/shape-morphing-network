...
4. When **inner** and **outer** edges are expanding and shrinking, the lattice buckles into a **sphere-like** shape;
   when **inner** and **outer** edges are shrinking and expanding, the lattice buckles into a **sphere-like** shape, it forms a **saddle-like** shape.
